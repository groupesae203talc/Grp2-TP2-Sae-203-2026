...
<link rel="stylesheet" href="./ressources/css/lieux.css?v=3"></head>
    ...
    <main class="conteneur-principal conteneur-1280">
        ...
        <section>
            ...
            <ul class="liste-lieux">
                <li>
                    <div>
                        <img class="image" src="https://bibliotheque.cyu.fr/medias/photo/photos-site-web-_1758187863476-png?ID_FICHE=153913" alt="">
                    </div>
                ...
                <li>
                    <div>
                        <img class="image" src="https://cyu.supaviation.com/_next/image?url=%2Fimage%2FIUT%2FCantine.webp&w=1200&q=75" alt="">
                    </div>
                    <section class="textes">
                ...
                <li>
                    <div>
                        <img class="image" src="https://www.cyu.fr/sites/default/files/styles/actualite_detail/public/content/actualites/images/Station_Numixs.jpg.webp?itok=TrhhaueO" alt="">
                    </div>
                    <section class="textes">
