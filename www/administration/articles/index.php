...
$nombre_articles = mysqli_num_rows($resultat_brut);
//on ajoute cette variable qui va permettre de calculer le nombre de lignes dans la requête brut qui extrait tous les éléments de la table "article"
    ...
    <header class="bg-white shadow">
        <div class="mx-auto max-w-7xl py-3 px-4 justify-between flex">
            <div>
                ...
                <p class="text-gray-500 text-sm">Nombre d'articles : <?php echo $nombre_articles; ?></p>
                <!--on ajoute le nombre d'articles dans l'administration en indiquant au php d'afficher la variable nombre_message qui représente le nombre de lignes dans la BDD!-->
            </div>
