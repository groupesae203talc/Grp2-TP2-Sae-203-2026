<footer class="pied-de-page-principal conteneur-1280">
    ...
    <section class="textes">
        ...
        <ul class="liste-liens">
            ...
            <li>
                <a aria-label="Ouverture dans un nouvel onglet" href="https://www.instagram.com/cy_univ/" title="Ouverture dans un nouvel onglet"  target="_blank">Instagram</a>
            </li>
            <!--
            ...
            <li>
                <a href="./administration/index.php" class="lien-admin">Accéder à l'administration</a> <!--on modifie le chemin d'accès lorsqu'on clique sur administration pour que le formulaire de connexion s'affiche instantannément!-->
            </li>
        </ul>
